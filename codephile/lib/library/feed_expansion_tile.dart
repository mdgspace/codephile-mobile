...
/// [FeedExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class FeedExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const FeedExpansionTile({
    Key key,
    this.leading,
    @required this.title,
    this.subtitle,
  ...
  @override
  _FeedExpansionTileState createState() => _FeedExpansionTileState();
}

class _FeedExpansionTileState extends State<FeedExpansionTile>
